...
const Home = () => {
  ...
  //       .map((el) => "Dr" + " " + el.lastName + " " + el.name)
  //   : null;
  // const data1 = med
  //   ? med.filter((el) => el.isDoctor === true).map((el) => el)
  //   : null;
  ...
  // const ld3 = document.getElementById("Tokyo1");

  const openCity1 = () => {
    ld1.style.display = "block";
    ld2.style.display = "none";
    // ld3.style.display = "none";
  };
  const openCity2 = () => {
  ...
  //   ld1.style.display = "none";
  //   ld2.style.display = "none";
  //   ld3.style.display = "block";
  // };
  // const sendMsg = async () => {
  //   const token = await getToken();
  //   // console.log(token)
  //   // const senderAdress = "+21656813222";
  //   const address = "+21652825132";
  //   const message = "bonjour from dali";
  ...
  // const handleGo = () => {
  //   navigate("/filter", {
  //     state: { specialitéText, regionText },
  //   });
  // };
  // const cherche = async () => {
  //   // console.log(search);
            ...
            <>
              <div className="part1">
                ...
                <div className="hero">
                  <div id="London1">
                    ...
                    <h5>
                      Sélectionnez votre médecin, choisissez la date et l'heure
                      de votre rendez-vous et recevez votre sms/mail de
                      confirmation. C’est aussi simple que ça !
                    </h5>
                  </div>
                  <div id="Paris1" style={{ display: "none" }}>
                    <h1>
                      Trouvez rapidement la pharmacie la plus proche de chez
                      vous !
                    </h1>
                    <h5>
                      Optimisez votre temps et trouvez facilement la pharmacie
                      ouverte la plus proche de chez vous !
                    </h5>
                  </div>
                  {/* <div
                id="Tokyo1"
                ...
                /> */}
                            ...
                            {filteredResults.map((item) => (
                              <Card className="crdd">
                                <Link
                                  ...
                                  // state={{ doc: med }}
                                  // profileProps: { el: item },
                                >
                                  <CardHeader className="hedd">
                                    <img className="iimmg" src={item.image2} />
                                    <h5 className="hedd1">
                                      {" "}
                      ...
                      <Col>
                        ...
                        {/* <button
                          disabled={
                            !specialitéText && !regionText ? true : false
                          }
                ...
                <div>
                  ...
                  <h4>
                    SantéLib pour les professionnels, c’est un ensemble de
                    services et d’accompagnement quotidien.
                  </h4>
                </div>
                <Row
                  style={{
                ...
                <Row className="mt-5">
                  ...
                  <Col className="d-flex align-items-center">
                    <div>
                      ...
                      >
                        Le service SantéLib est accessible pour vous et vos
                        proches. En créant un compte familial, vous simplifiez
                        vos démarches et vos parcours de soins. Profitez
                        également gratuitement du carnet de vaccination
                        électronique via mesvaccins.net.
                      </p>
                    </div>
                  </Col>
                </Row>
              ...
              <Row>
                <Col className="d-flex align-items-center">
                  <div>
                    <h3>
                      Gagnez du temps, prenez rendez-vous avec vos praticiens
                    </h3>
                    <p
                      style={{
                        fontFamily: "IBM Plex Sans,sans-serif",
              ...
              {/* <button onClick={() => sendMsg()}>dzdzdzdzdz</button> */}
            </>
          ) : (
            <Loader />
          )}
